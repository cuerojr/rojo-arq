      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="">
          {slice.primary.items.map((item: any, index: number) => (
            <div
              key={index}
              className="category-item grid grid-cols-12 gap-10 items-center py-28 border-b border-rojoarq-stone"
            >
              <div
                className={cn(
                  dinamicStyle.textCont[index % 2],
                  "col-span-12 md:col-span-6 space-y-5 flex flex-col justify-between h-full pt-4",
                )}
              >
                <h2 className="px-10 text-2xl md:text-4xl leading-[1.24] font-semibold text-pretty">
                  {item.title}
                </h2>

                <div className="px-10 text-sm md:text-lg leading-6 text-pretty flex flex-col gap-4">
              ...
              <div
                className={cn(
                  ...
                  "col-span-12 md:col-span-6 aspect-square overflow-hidden",
                )}
              >
                <PrismicNextImage
                  field={item.image}
              ...
              {/**
                ...
                className={cn(
                  dinamicStyle.thumbnailsCont[index % 2],
                  "d-none hidden col-span-12 md:col-span-5 md:col-start-2 grid grid-cols-4 grid-rows-2 gap-2 items-start",
                )}
              >
                <div className="col-span-1 sm:col-span-2 row-span-1 aspect-square overflow-hidden ">
                  <PrismicNextImage
                    field={item.thumbnail1}
                    width={item.thumbnail1.dimensions?.width}
                    height={item.thumbnail1.dimensions?.height}
